...
// deleteMin( minItem)		--> Remove (ad optionally return smallest item)
// Comparable findMin( )	--> Return smallest item
// bool isEmpty( )			--> Return true if empty; else false
// void makeEmpty( )		--> Remove all items
// **********************ERRORS***************************
// Throws UnderflowExceptions as warranted
...
public:
	...
	*/
	void insert(Comparable&& x)
	{
		...
		// Percolate up
		int hole = ++currentSize;
		for (; hole > 1 && < array[hole / 2]; hole /= 2) array[hole] = std::move(array[hole / 2]);
...
private:
	...
	*/
	void buildHeap()
	{
		for (int i = currentSize / 2; i > 0; --1) percolateDown(i);
	}
